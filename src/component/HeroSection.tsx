            ...
            <div className="px-5 pt-[55px]">
                <div className="main-container">
                    <div className="space-y-2.5 text-center mb-[19px]">
                        <h1 className='display-32 text-black leading-[44px]'>Găsește furnizori de servicii medicale în apropierea ta</h1>
                        <h2 className='h1-28 text-black leading-[36px]'>Caută medici, specialişti, clinici și spitale din zona ta</h2>
                    </div>
                    <div className="max-w-[600px] w-full mx-auto">
                        <div className="relative">
                            <input type="text" placeholder="Caută după specialitate, nume sau afecțiune" className="caption-14 w-full bg-white py-3 md:py-3.5 ps-[15px] md:ps-5 pe-[50px] md:pe-[52px] shadow-4 rounded-[5px] placeholder:text-placeholder-color" />
