...
const HeroSection = () => {
    const { searchQuery, setSearchQuery, handleSearch, handleLocation } = useApp();
                    ...
                    <div className="max-w-[600px] w-full mx-auto">
                        <div className="relative">
                            <input
                                ...
                                className="caption-14 w-full bg-white ps-[15px] md:ps-5 pe-[58px] md:pe-[70px] shadow-4  placeholder:text-placeholder-color"
                            />
                            <button
                                onClick={handleSearch}
                                className='cursor-pointer aspect-square bg-[#2C69F7] absolute top-0 right-0 h-full flex items-center justify-center text-white rounded-tr-2 rounded-br-2'
                            >
                        ...
                        <div
                            ...
                            className="flex items-center gap-1.5 mt-7 md:mt-9 hover:cursor-pointer"
                        >
